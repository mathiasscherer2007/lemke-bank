...
<svelte:head>
  <title>Erro | LemkeBank</title>
</svelte:head>

<div class="flex min-h-screen flex-col">
  <main class="flex flex-1 flex-col bg-white dark:bg-[rgb(27,27,26)]">
    <div class="relative flex flex-col items-center justify-center flex-1 px-10 lg:px-15 py-10 text-neutral-900 bg-teal-50/25 dark:bg-[rgb(45,46,45)] dark:text-white">
