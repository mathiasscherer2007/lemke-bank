class e {
  constructor(a, b, c, d, f) {
    ...
    this._legacyCanvasSize =
      'number' === typeof c ? c : 'number' === typeof d ? d : this._legacyCanvasSize;
  ...
  static async listCameras(a = !1) {
    ...
    let b = async () =>
        (await navigator.mediaDevices.enumerateDevices()).filter((d) => 'videoinput' === d.kind),
      c;
    try {
      a &&
  ...
  static _drawToCanvas(a, b, c, d = !1) {
    ...
    b = c.getContext('2d', { alpha: !1, willReadFrequently: true });
